...
file(GLOB U8G2_PORT_SRC_FILES "${U8G2_DIR}/sys/arm-linux/port/u8g2port.c")
file(GLOB U8G2_PORT_HEADER_FILES "${U8G2_DIR}/sys/arm-linux/port/u8g2port.h")
file(COPY ${U8G2_PORT_HEADER_FILES} DESTINATION ${PROJECT_BINARY_DIR}/install/u8g2/include)

file(GLOB U8G2_DRIVERS_SRC_FILES "${U8G2_DIR}/sys/arm-linux/drivers/*.c")
file(GLOB U8G2_DRIVERS_HEADER_FILES "${U8G2_DIR}/sys/arm-linux/drivers/*.h")
file(COPY ${U8G2_DRIVERS_HEADER_FILES} DESTINATION ${PROJECT_BINARY_DIR}/install/u8g2/include)
